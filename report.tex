...
\begin{lstlisting}[firstnumber=13, caption={Code snippet from ElectromagneticCalorimeter.cpp showing the detect function and how the flags and misdetect function is incorparated.}, label=detectorsub]
double ElectromagneticCalorimeter::detect(const Particle &particle) const
{
