...
\label{intro}
The aim of this project was to create a C++ library that simulates a particle detector, through sub-detectors and the particles commonly found in accelerators. This was done through two inheritance chains, one for the sub-detectors with the base class SubDetector and one for particles with base class Particle. 
