...
\begin{lstlisting}[firstnumber=13, caption={Code snippet from Tau.cpp decay member function. Neutrino instantiation and energy/momentum calculation omitted for clarity}, label=strtopt]
