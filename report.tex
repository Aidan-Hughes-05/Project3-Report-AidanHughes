...
To create classes for the particles, an inheritance hierarchy was used, shown in Figure \ref{particleuml}. The Particle, Hadron and Lepton classes are abstract classes, so they cannot be instantiated, but allow child classes to inherit important data members and member functions from them. 
...
\ref{ruleof5}, and the move constructor and assignment, for which the default was sufficient.
