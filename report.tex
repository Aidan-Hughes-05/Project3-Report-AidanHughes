...
The ParticleBunch can be constructed from a vector of strings, which is the same way the main.cpp file reading function outputs the data read in. 
PLAN
OOP EXAMPLES 
