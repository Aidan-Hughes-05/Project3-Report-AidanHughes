...
A major benifit of constructing separate class to hold particle four momentum is to be able to overload operators, such as the addition and increment operators shown in Listing \ref{fmoperator}
